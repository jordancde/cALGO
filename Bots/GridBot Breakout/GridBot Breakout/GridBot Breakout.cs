...
namespace cAlgo.Robots
{
    ...
    public class George : Robot
    {
        ...
        [Parameter("Keltner Period", DefaultValue = 30)]
        public int maPeriod { get; set; }

        [Parameter("Keltner Band", DefaultValue = 30)]
        ...
        protected override void OnTick()
        {
            ...
            {
                if (Symbol.Bid > keltner.Top.LastValue)
                {
                    brokenTop = true;

                }
                if (Symbol.Bid < keltner.Bottom.LastValue)
                {
                    brokenBottom = true;
